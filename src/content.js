...
import student from './img/student.png'
    ...
    const generalHobby = <p>I'm a Quality Assurance Specialist with 2 years of experience. I find it really cool, but I can't unleash my full potential in such a position. Since I can remember I have liked to create pretty things.  I also consider myself passionate about technology and what is associated with it. That's why I'd like to become a <span>programmer</span> and the front-end is a great combination of both of these worlds.
     <br></br><br></br>
     I have also completed Bachelor's Degree in Finance and Accounting at Warsaw University of Life Sciences. <img alt='student icon' class='icon' src={student}></img> Most of my free time I spend on gym and computer games.</p>

    const sportHobby = <p>Sport has always been present in my life. I have been playing football <img alt='football icon' class='icon' src={football}></img> since I was little. I was even an active player in a district league club. I am also interested in bodybuilding. <img alt='barbell icon' class='icon' src={barbell}></img> 
    <br></br><br></br>
    ...
    const naturalSciencesHobby = <p>The school killed the scientist bug in me, but now I am beginning to appreciate the power of <span>mathematics</span> and <span>physics</span>. The complexity of our world on both the micro <img alt='atom icon' class='icon' src={atom}></img> and macro <img alt='planet icon' class='icon' src={planet}></img> scale is amazing.
    <br></br><br></br>
     I love reading books and watching movies about nature and <span>astrophysics</span>. If it wasn't necessary to learn chemistry, I would probably be a doctor now. I wonder if it a coincidence that Atom was my first code editor and I started my adventure with frameworks from React. <img alt='react icon' class='icon' src={physics}></img> </p>

    const gamesHobby = <p>I treat games as a great form of spending time with my friends. The athlete's soul makes me love <span>competition</span>. When it comes to games, I also like to be the best. <img alt='grow icon' class='icon' src={grow}></img> That's why I love <img alt='heart icon' class='icon' src={heart}></img> highly competitive multiplayer games the most. I believe that I learned more English while playing than in school.
     <br></br><br></br>
    As a QA Specialist, I have had an opportunity to test a lot of titles. It's a fun experience to be involved in the games' <span>development</span> <img alt='puzzle icon' class='icon' src={puzzle}></img>process. </p>
